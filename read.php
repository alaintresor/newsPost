            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="admin/postimages/<?php echo $newsInfor["PostImage"]; ?>" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="category.php?catId=<?php echo $newsInfor['CategoryId'] ?>">
                                          <?php $categoryInfor=mysqli_fetch_array(mysqli_query($connect,"SELECT `CategoryName` FROM `tblcategory` WHERE `id`='{$newsInfor['CategoryId']}'")); echo $categoryInfor[0]; ?>
                                        </a>
                                <a class="text-body" href="">Jan 01, 2045</a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">
<?php echo $newsInfor['PostTitle']; ?>
                            </h1>
                            <p><?php echo $newsInfor["PostDetails"]; ?></p>
                        </div>
