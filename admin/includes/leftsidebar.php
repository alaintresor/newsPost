                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <li class="has_sub">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Advantiserment  </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                        ...
                        <li class="has_sub">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>Editors</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="addEditor.php">Add Editor</a></li>
                                    <li><a href="manage-editor.php">Manage Editors</a></li>
                                </ul>
                            </li>
                   <li class="has_sub">
