...
if($num<=0)
{
    $sql=mysqli_query($con,"INSERT into tbladmin(AdminUserName,AdminEmailId,AdminPassword) values('$name','$email','$hashedpass')");
...
{
$error="This email already Exist in the system !!";
}
}
