											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"SELECT * from  tbladmin WHERE AdminUserName!='admin'");
$cnt=1;
...
<td>
<?php if($st==0):?>
    <a href="edit-editor.php?eid=<?php echo htmlentities($row['id']);?>" title="Edit this editor"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
...
<?php endif;?>
	...
	&nbsp;<a href="manage-editor.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
