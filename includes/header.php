      ...
      >
        ...
        >
          <div class="navbar-nav mr-auto py-0">
            ...
            <a href="category.php?catId=5" class="nav-item nav-link">Entertainment</a>
            <a href="category.php?catId=6" class="nav-item nav-link">Politics</a>
            <a href="category.php?catId=3" class="nav-item nav-link"
              >Sport</a
            >
            
            <a href="category.php?catId=7" class="nav-item nav-link "
              >Business</a
            >
            <a href="single.html" class="nav-item nav-link">Health</a>
            <a href="single.html" class="nav-item nav-link">Other</a>
