...
if(isset($_GET['id']))
{
$trandingNews=mysqli_query($connect,"SELECT * FROM `tblposts` WHERE `id`!={$_GET['id']} ORDER BY `tblposts`.`PostingDate` DESC LIMIT 5;");
}else
$trandingNews=mysqli_query($connect,"SELECT * FROM `tblposts` ORDER BY `tblposts`.`PostingDate` DESC LIMIT 5;");
?>
<div class="mb-3">
