                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                     ...
                     while($row=mysqli_fetch_array($query)){
                      ?>     <a class="text-secondary text-uppercase font-weight-semi-bold" href=""><?php echo $row['PostTitle'];?></a> <?php }?></div>
                           <div class="text-truncate">
                                <a class="text-secondary text-uppercase font-weight-semi-bold" href="">Lorem ipsum dolor sit amet elit. Proin interdum lacus eget ante tincidunt, sed faucibus nisl sodales</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    $id=$_GET['id'];
                     $conn=new mysqli("localhost","root","","world_show");
                     $sql="SELECT tblposts.PostImage,tblposts.PostingDate,tblposts.PostDetails,tblposts.PostTitle,tblcategory.CategoryName FROM tblposts,tblcategory 
                     where tblposts.CategoryId=tblcategory.id AND tblposts.id='$id'";
                     $query=$conn->query($sql);
                    ...
                    <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                ...
                                <a class="text-body" href="">Published on: <?php echo $row['PostingDate'];?></a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"><?php echo $row['PostTitle'];?></h1>
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle mr-2" src="img/images.jpg" width="25" height="25" alt="">
